...
st.markdown("<h3 style='text-align: left; color: blue;'>The results of iterations</h3>",
...
iteration_result, iteration_result1, iteration_diff = logistic_equation(
    iteration_steps, initial_value, initial_value1, growth_rate)

# The first iteration results
f, ax = plt.subplots(figsize=(8, 4))
plt.title('Results of the first iteration', fontsize=10)
plt.plot(iteration_result, color='r', lw=0.3,
         marker='o', mec='r', mfc='r', ms=3)
plt.ylim(0.0, 1.0)
...
plt.plot(iteration_result, color='r', lw=0.3,
         marker='o', mec='r', mfc='r', ms=3)
plt.plot(iteration_result1, color='b', lw=0.3,
         marker='D', mec='b', mfc='b', ms=3, alpha=0.5)
plt.ylim(0.0, 1.0)
plt.xlim(-1, iteration_steps+1)
my_x_ticks = get_xticks(iteration_steps)
my_y_ticks = np.arange(0.0, 1.0, 0.1)
...
if st.button('Show me the numbers!'):
    st.markdown("<h3 style='text-align: left; color: blue;'>The numerical values of iterations</h3>",
                unsafe_allow_html=True)
    results = np.column_stack(
        (iteration_result, iteration_result1, iteration_diff))
